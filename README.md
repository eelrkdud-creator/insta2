...
인스타그램 게시물 URL만 있으면 로그인 없이 최초 업로드 시간(KST), 수정 여부, 수정 시간, 좋아요, 댓글, 조회수(릴스) 정보를 확인할 수 있는 웹 서비스입니다.
...
- **최초 업로드 시간 확인**: UTC 시간을 한국 표준시(KST)로 자동 변환하여 보여줍니다.
- **수정 여부 확인**: 게시물이 수정된 경우 수정 시간(KST)을 최초 업로드 시간과 함께 보여줍니다.
- **참여도 분석**:
  - 게시물: 좋아요, 댓글 수
  - 릴스: 좋아요, 댓글 수 + **조회수**
